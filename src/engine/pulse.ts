...
export class Pulse extends Particle {
    constructor(game: Game, x: number, y: number, private radius: number, duration = 1, private ringWidth = 0, private alpha = 40) {
        super(game, x, y, radius, radius, (0.3 + Math.random() * 0.1) * duration, ZERO);
    }
